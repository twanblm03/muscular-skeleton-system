...
'''
python view_switched_state_mujoco_n=6_012.py --activate muscle1
python view_switched_state_mujoco_n=6_012.py --activate upper_front
python view_switched_state_mujoco_n=6_012.py --activate upper_back
python view_switched_state_mujoco_n=6_012.py --activate lower_front
'''
...
DEFAULT_XML_PATH = os.path.join(os.path.dirname(__file__), "system_model_n=6_012.xml")
ACT_THRESHOLD = 1e-6
DEFAULT_PRE_STEPS = 800
DEFAULT_TOTAL_STEPS = 10000
DEFAULT_RENDER_EVERY = 1
DEFAULT_PRINT_EVERY = 9999
...
TYPE_PARAM_TEMPLATES = {
    ...
    # d2=100
    "A": {"L0_state1": 0.0986, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0589, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "B": {"L0_state1": 0.11, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0657, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "C": {"L0_state1": 0.1203, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0718, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "D": {"L0_state1": 0.1293, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0772, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "E": {"L0_state1": 0.1367, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0816, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "F": {"L0_state1": 0.1424, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0815, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "G": {"L0_state1": 0.1463, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0874, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "H": {"L0_state1": 0.1483, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0885, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},

    # upper arm muscle--behind(bicep)
    # d1=210
    "I": {"L0_state1": 0.143, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0854, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "J": {"L0_state1": 0.1321, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0789, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "K": {"L0_state1": 0.1235, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0738, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "L": {"L0_state1": 0.1181, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0705, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "M": {"L0_state1": 0.1162, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0693, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
