...
'''
python view_switched_state_mujoco_n=4_008.py --activate muscle1
python view_switched_state_mujoco_n=4_008.py --activate upper_front
python view_switched_state_mujoco_n=4_008.py --activate upper_back
python view_switched_state_mujoco_n=4_008.py --activate lower_front
'''
...
DEFAULT_XML_PATH = os.path.join(os.path.dirname(__file__), "system_model_n=4_008.xml")
ACT_THRESHOLD = 1e-6
...
TYPE_PARAM_TEMPLATES = {
    ...
    # d2=170
    "A": {"L0_state1": 0.137, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0818, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "B": {"L0_state1": 0.146, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0872, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "C": {"L0_state1": 0.1543, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0921, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "D": {"L0_state1": 0.1617, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0965, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "E": {"L0_state1": 0.1678, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.1002, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "F": {"L0_state1": 0.1726, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.1031, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "G": {"L0_state1": 0.1759, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.105, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "H": {"L0_state1": 0.1775, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.106, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},

    # upper arm muscle--behind(bicep)
    # d1=220
    "I": {"L0_state1": 0.1535, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0916, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "J": {"L0_state1": 0.1465, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0875, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "K": {"L0_state1": 0.1412, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0843, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "L": {"L0_state1": 0.1378, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0823, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "M": {"L0_state1": 0.1366, "k_state1": 11.5, "c_state1": 1.0000,
