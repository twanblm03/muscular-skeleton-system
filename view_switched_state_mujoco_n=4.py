...
'''
python view_switched_state_mujoco_n=4.py --activate muscle1
python view_switched_state_mujoco_n=4.py --activate upper_front
python view_switched_state_mujoco_n=4.py --activate upper_back
python view_switched_state_mujoco_n=4.py --activate lower_front
'''
...
DEFAULT_XML_PATH = os.path.join(os.path.dirname(__file__), "system_model_n=4.xml")
ACT_THRESHOLD = 1e-6
DEFAULT_PRE_STEPS = 800
DEFAULT_TOTAL_STEPS = 6000
DEFAULT_RENDER_EVERY = 1
DEFAULT_PRINT_EVERY = 5999
DEFAULT_REALTIME_SLEEP = True
DEFAULT_ACTIVE_CTRL = 1.0

TYPE_PARAM_TEMPLATES = {
    # upper arm muscle--front(tricep)
    "A": {"L0_state1": 0.1268, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0757, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "B": {"L0_state1": 0.1376, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0822, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "C": {"L0_state1": 0.1475, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0881, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "D": {"L0_state1": 0.1562, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0933, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "E": {"L0_state1": 0.1634, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0976, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "F": {"L0_state1": 0.169, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.1009, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "G": {"L0_state1": 0.1728, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.1032, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "H": {"L0_state1": 0.1747, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.1043, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},

    # upper arm muscle--behind(bicep)
    "I": {"L0_state1": 0.1518, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0906, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "J": {"L0_state1": 0.1428, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0853, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "K": {"L0_state1": 0.1359, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0811, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "L": {"L0_state1": 0.1315, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0785, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "M": {"L0_state1": 0.13, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0776, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
...
def resolve_upper_origin(model: mujoco.MjModel, data: mujoco.MjData, upper_origin_body: Optional[str], upper_origin_xyz: Optional[np.ndarray]) -> np.ndarray:
    ...
    return np.array([-0.025, 0.0, -0.04], dtype=float)
