...
'''
python view_switched_state_mujoco_n=4_010.py --activate muscle1
python view_switched_state_mujoco_n=4_010.py --activate upper_front
python view_switched_state_mujoco_n=4_010.py --activate upper_back
python view_switched_state_mujoco_n=4_010.py --activate lower_front
'''
...
DEFAULT_XML_PATH = os.path.join(os.path.dirname(__file__), "system_model_n=4_010.xml")
ACT_THRESHOLD = 1e-6
...
TYPE_PARAM_TEMPLATES = {
    ...
    # d2=120
    "A": {"L0_state1": 0.1014, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0605, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "B": {"L0_state1": 0.112, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0668, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "C": {"L0_state1": 0.1216, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0726, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "D": {"L0_state1": 0.13, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0776, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "E": {"L0_state1": 0.137, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0818, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "F": {"L0_state1": 0.1424, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.085, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "G": {"L0_state1": 0.146, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0872, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "H": {"L0_state1": 0.1479, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0883, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},

    # upper arm muscle--behind(bicep)
    # d1=200
    "I": {"L0_state1": 0.1329, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0794, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "J": {"L0_state1": 0.1238, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0739, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "K": {"L0_state1": 0.1167, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0697, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "L": {"L0_state1": 0.1122, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.067, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
    "M": {"L0_state1": 0.1107, "k_state1": 11.5, "c_state1": 1.0000,
          "L0_state2": 0.0661, "k_state2": 22.5, "c_state2": 1.0000,
          "F_active_max": 2.4, "FORCE_SIGN": -1.0},
